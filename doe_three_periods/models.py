...
class Constants(BaseConstants):
    print('creating the constants class of doe-three-periods')
    num_rounds = 27
    # name_in_url = 'dyn_opt_exp'
    name_in_url = 'doe_three_periods'
    instructions_template = 'doe_three_periods/instructions.html'
    decision_box_component = 'doe_three_periods/DecisionBox.html'
    calculator_component = 'doe_three_periods/CalculatorComponent.html'
    in_between_component = 'doe_three_periods/InBetween.html'
    # output_to_points_converter_component = 'doe_three_periods/OutputToPointsConverter.html'
    output_to_points_conversion_component = 'doe_three_periods/OutputToPointsConversion.html'
    players_per_group = None

class Subsession(BaseSubsession):
    print('subsessions in the models.py for doe-three-periods')
